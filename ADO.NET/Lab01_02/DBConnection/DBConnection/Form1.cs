...
namespace DBConnection
{
    public partial class Database : Form
    {
        ...
        //string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\akasyanov\Northwind.mdf; Integrated Security=true; Connect Timeout=30";
        ...
        {
            подключитьсяКБДToolStripMenuItem1.Enabled = (e.CurrentState == ConnectionState.Closed);
        ...
        private void подключитьсяКБДToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (connection.State != ConnectionState.Open)
                {
                    ...
                    connection.Open();
                    MessageBox.Show("Соединение с базой данных " + connection.Database +
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    while (reader.Read())
                    {
                       ...
                       newItem.SubItems.Add(reader[1].ToString()); 
