...
namespace LINQsqlSproc
{
    ...
    {
        Northwnd db = new Northwnd(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\akasyanov\Northwind.mdf; Integrated Security=true; Connect Timeout=30");
        public Form1()
        {
            InitializeComponent();
        }
