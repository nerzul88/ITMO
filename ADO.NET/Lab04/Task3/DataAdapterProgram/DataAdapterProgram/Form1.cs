...
namespace DataAdapterProgram
{
    ...
    {
        static SqlConnection NorthwindConnection = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\kloko\Northwind.mdf; Integrated Security=true; Connect Timeout=30");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Object[] CustRecord = { "AAAAA", "Alfreds Futterkiste", "Maria Anders", 
                "Sales Representative", "Obere Str. 57", "Berlin", null, "12209", "Germany", "030-0074321", "030-0076545" }; 
